...
import { Phone, ShieldCheck, ArrowRight, AlertCircle, Loader2 } from 'lucide-react';
...
export const PhoneForm: React.FC<PhoneFormProps> = ({ onSubmit, isLoading }) => {
        ...
        <div className="p-3.5 rounded-xl bg-zinc-50 dark:bg-zinc-800/40 border border-zinc-100 dark:border-zinc-800/80">
          <div className="flex gap-2.5 items-start">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-normal">
              Mit dem Fortfahren stimmen Sie dem Versand einer SMS an diese Telefonnummer zu.
            </p>
          </div>
        </div>
