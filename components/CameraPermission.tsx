  ...
  return (
    <div className="w-full max-w-md mx-auto p-6 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl rounded-2xl shadow-xl border border-zinc-200/80 dark:border-zinc-800 transition-all">
      ...
      <p className="mt-3 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
        Für den nächsten Schritt benötigt diese Website Zugriff auf Ihre Kamera. Die Kamera wird nur aktiviert, wenn Sie die Berechtigung ausdrücklich erteilen.
      </p>
      ...
      <div className="mt-5 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800/40 border border-zinc-100 dark:border-zinc-800 space-y-2">
        ...
        <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-normal">
          Es findet keine heimliche Aufnahme statt. Die Übertragung ist live und kann jederzeit durch Sie beendet werden.
        </p>
      </div>
      ...
      >
        ...
        <span>{isLoading ? 'Zugriff anfragen...' : 'Kamera freigeben'}</span>
      </button>
    </div>
  );
};
